...
public class VelocityTemplateFactory extends TemplateFactory {
    ...
    public VelocityTemplate loadTemplate(String path) throws Exception {
    ...
    public void init(Config config) {
        ...
        try {
            if(rtInstance.getProperty(RuntimeConstants.FILE_RESOURCE_LOADER_PATH)==null) {
                rtInstance.setProperty(RuntimeConstants.FILE_RESOURCE_LOADER_PATH, webAppPath + "/WEB-INF/velocity/");
